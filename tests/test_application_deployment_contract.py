...
def _contract():
    ...
    value = {
        ...
        "authorization": {
            ...
            "observed_at": "2026-08-16T10:00:00Z", "expires_at": "2026-08-16T12:00:00Z",
            "capabilities": ["coding.governed-execution@1"], "phases": ["W09"],
            ...
            "retirement_condition": "W10:canonical-gate-operational", "deployment_uses": 1,
        },
        "candidate": {
            "commit": "a" * 40, "tree": "b" * 40, "archive_sha256": h("2"),
            "candidate_evidence_bundle_hash": h("3"), "manifest_hash": h("4"),
            "release_manifest_hash": h("5"), "rollback_manifest_hash": h("6"),
            "admission_gate_hash": h("7"), "predecessor_commit": "c" * 40,
            "predecessor_tree": "d" * 40, "predecessor_archive_sha256": h("8"),
            "predecessor_release_manifest_hash": h("9"), "predecessor_content_manifest_sha256": h("a"),
        },
        "archive": {
            "artifact_ref": "artifact:candidate", "content_sha256": h("2"), "size_bytes": 123,
            "embedded_commit": "a" * 40, "release_manifest_hash": h("5"),
            "content_manifest_sha256": h("b"), "file_count": 10,
        },
        "plan": {
            "commit": PLAN_COMMIT, "tree": "e" * 40, "solution_hash": SOLUTION_HASH,
            "closure_hash": CLOSURE_HASH, "graph_hash": h("c"), "work_unit": "W09",
        ...
        "migrations": [
            {"path": path, "source_sha256": h(str(index + 1)), "receipt_hash": h(str(index + 3))}
            for index, path in enumerate(MIGRATION_PATHS)
        ],
        "deployment": {
            "target_host": "tgw-prod", "root_id": "production-releases", "release_root": "/opt/TGW",
            "artifact_ref": "artifact:candidate", "prior_generation": "release-a", "next_generation": "release-b",
        ...
        "rollback": {
            "generation": "release-a", "manifest_hash": h("6"), "database_backup_required": True,
            "selector_cas_required": True, "config_reconciliation_required": True,
            "service_reconciliation_required": True, "predecessor_health_required": True,
        },
...
def _verified():
    contract = _contract()
    receipts = tuple({
        "migration_path": item["path"], "migration_sha256": item["source_sha256"],
        "receipt_hash": item["receipt_hash"],
    } for item in contract["migrations"])
    return VerifiedApplicationDeploymentContract(
        "candidate:" + "a" * 40 + ":application-bootstrap:v1", contract["contract_hash"], contract, receipts,
    )
...
def _application_controller(*, install, rollback, recorder):
    ...
    effect = TypedEffect.parse({
        ...
        "parameters": {"schema": "tgw-approval-application-bootstrap/v1", "application_contract_ref": verified.reference,
