...
SOURCE_REF = "artifact:sha256:0dd33b208fe978cf393e44656636f9717716a9a5aef8da1475c67b17d5947a58"
SOURCE_PATH = Path("/opt/TGW/tgw-lib/actors/codex/artifacts/sha256/0dd33b208fe978cf393e44656636f9717716a9a5aef8da1475c67b17d5947a58.tar")
...
def preflight_reviewed_evaluation(parameters: Mapping[str, str]) -> dict[str, Any]:
    ...
    artifacts = (
        ("source_archive", SOURCE_PATH, 0o444, 8_847_360, parameters["source_archive_sha256"]),
    ...
    return {
        ...
        "request_hash": "sha256:788fa3d28e810d7c8a392d87940de803a1a504fedbaefbe8de309d7f3f67fc67",
