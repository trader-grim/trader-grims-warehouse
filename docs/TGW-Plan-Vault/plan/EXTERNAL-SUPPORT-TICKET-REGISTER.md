...
| `EBAY-DS-260605-000035` | **Application Growth Check.** Existing App Check / `buy.marketplace_insights` scope request, now including the EPS / `UploadSiteHostedPictures` daily call-limit increase request (taskboard #1076). | `260605-000035` | `response-received / needs Dave response` | Developer Support has eight open Marketplace Insights questions. The API-rate-increase request was added to this active case; preserve the provider reply and record the specific EPS decision/limit if returned. Prepared attachment: `/home/db/Sync/ebay-dev-support-eps-limit-increase.txt`. Source: taskboard #79 and #1076; `reference/DRAFT-1076-eps-support-ticket.md`. |
