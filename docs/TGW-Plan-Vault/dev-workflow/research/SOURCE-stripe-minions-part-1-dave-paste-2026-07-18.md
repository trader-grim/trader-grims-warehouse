# Source capture — Stripe Minions, Part 1

**Source URL:** https://stripe.dev/blog/minions-stripes-one-shot-end-to-end-coding-agents
**Title:** Minions: Stripe’s one-shot, end-to-end coding agents
**Author/date:** Alistair Gray; 2026-02-09 (metadata independently retrieved from the first-party page)
